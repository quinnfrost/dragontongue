...
public abstract class MixinEntityLightningDragon extends EntityDragonBase {
    public MixinEntityLightningDragon(EntityType t, Level world, DragonType type, double minimumDamage, double maximumDamage, double minimumHealth, double maximumHealth, double minimumSpeed, double maximumSpeed) {
