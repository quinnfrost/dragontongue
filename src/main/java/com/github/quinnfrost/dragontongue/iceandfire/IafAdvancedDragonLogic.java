...
//                && dragon.getDistanceSquared(Vector3d.copyCentered(dragon.getHomePosition())) < dragon.getWidth() * 12
            ...
            if (navigator.isDone() && dragon.level.getGameTime() - navigator.pathStartTime < 10) {
                if (dragon.position().distanceTo(Vec3.atBottomCenterOf(dragon.getRestrictCenter())) < 12) {
