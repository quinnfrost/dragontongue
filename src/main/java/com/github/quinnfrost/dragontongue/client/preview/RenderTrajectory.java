...
public class RenderTrajectory {
    ...
    static Color primaryDotColor = new Color(0x75aaff);
    static Color secondaryDotColor = new Color(0xe7ed49);
                    ...
                    if (targets != null) {
                        ...
                        while (var29.hasNext()) {
                            ...
                            for (short cycle = 0; e.isAlive(); ++cycle) {
                                ...
                                if ((double) Mth.sqrt((float) playerEntity.distanceToSqr(newPoint)) > (Double) pathStart) {
...
//                            Color color1 = new Color(Integer.parseInt("75aaff", 16));
//                            Color color2 = new Color(Integer.parseInt("e7ed49", 16));
